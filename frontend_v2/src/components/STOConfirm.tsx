        ...
        <div className="rounded-xl bg-black/50 p-4 border border-gray-600 space-y-3 backdrop-blur-sm">
          ...
          <div className="flex justify-between text-sm">
            <div className="flex items-center gap-1 text-gray-400">
              예상 가스비
              <svg className="w-3.5 h-3.5 cursor-help text-gray-400 hover:text-[#1ABCF7] transition-colors" fill="currentColor" viewBox="0 0 20 20" title="블록체인 네트워크 혼잡도에 따라 변동될 수 있습니다">
